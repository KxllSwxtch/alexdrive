      ...
      <header className="sticky top-0 z-50 border-b border-border bg-bg-primary/80 backdrop-blur-xl">
        <div className="flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <Link href="/" className="flex items-center group">
            <Logo className="logo-glow" />
          </Link>

          {/* Desktop WhatsApp CTA (nav links moved to sidebar) */}
          <a
            href="https://wa.me/821039086050"
            target="_blank"
            rel="noopener noreferrer"
            className="hidden lg:inline-flex items-center gap-2 rounded-lg bg-gold px-4 py-2 text-sm font-semibold text-bg-primary transition-colors hover:bg-gold-light"
          >
