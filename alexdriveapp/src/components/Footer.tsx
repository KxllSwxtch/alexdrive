        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div>
            ...
            <p className="mt-3 text-sm leading-relaxed text-text-secondary">
              Автомобили в Южной Корее.
              <br /> Широкий выбор автомобилей в Сувоне
            </p>
          </div>
          ...
          <div>
            ...
            <div className="mt-3 flex flex-col gap-2 text-sm">
              ...
              <p className="text-text-secondary">Кёнги, Сувон, Южная Корея</p>
            </div>
          </div>
        </div>

        <div className="mt-8 border-t border-border pt-6 text-center text-xs text-text-secondary">
          &copy; {new Date().getFullYear()} AlexDrive. Все права защищены.
        </div>
      </div>
    </footer>
  )
