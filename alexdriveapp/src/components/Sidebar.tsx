...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-[var(--sidebar-width)] sticky top-16 h-[calc(100vh-4rem)] border-r border-border bg-bg-surface shrink-0">
      {/* Menu label */}
      ...
      <div className="mt-auto border-t border-border p-4">
        <a
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg bg-gold px-4 py-3 text-sm font-semibold text-bg-primary transition-colors hover:bg-gold-light"
        >
