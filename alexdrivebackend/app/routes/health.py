...
from app.services.salecars import get_last_successful_parse, is_rate_limited, _location_cache, _excluded_car_ids, _verified_suwon_ids, _listing_cache
...
async def health():
    ...
    return {
        ...
        "verified_suwon_count": len(_verified_suwon_ids),
